export const ListaDeProductos= [{
    ...
    id: "004",
    nombre: "Panos de Microfibra",
    caracteristica: ['Larga duracion', 'Ultra absorbentes', '80% Poliester, 20% Poliamida' , '40,6 cm x 40,6 cm', 'Para uso del interior y exterior de tu carro', 'Producto importado de alta calidad'],
    presentacion: 'Paquete de 2 Unidades',
    precio: "$11.900",
    obsequio: null,
    img: "pic4"
}]